...
export class PropertyComponent implements OnInit {
  ...
  constructor(private modalService: NzModalService, private estateService: EstateService, private propertyService: PropertyService, private oprationService: OprationService) { }
